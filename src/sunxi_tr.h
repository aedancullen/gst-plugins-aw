...
typedef enum
{
	...
	TR_HFLIP_ROT_90 = 0x5,//first horizontal flip then rotate clockwise 90 ROTgree
	TR_VFLIP        = 0x6,//vertical flip
	TR_VFLIP_ROT_90 = 0x7,//first vertical flip then rotate clockwise 90 ROTgree
}tr_mode;
